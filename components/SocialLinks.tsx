    ...
    return (
        <>
            ...
            <div className="flex gap-5  text-white ml-auto " >
                <Link href="https://github.com/Mahtot" title="Github" className="border border-[#b57d6a] rounded-full p-2 bg-white text-[#9C3A14] hover:text-white hover:bg-[#9C3A14] transition-all duration-300">
